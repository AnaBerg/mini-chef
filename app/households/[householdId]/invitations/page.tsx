...
export default async function InvitationsPage({ params }: { params: Promise<{ householdId: string }> }) {
  ...
  let invitations;
  try { invitations = await listInvitations(getDomainExecutor(), householdId); }
  catch (error) {
